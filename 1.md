...
- [Introduction to Python](#1-introduction)
...
* Used by major deep learning frameworks (e.g., **PyTorch**, **TensorFlow**)
...
#### 2. Notebook environment: **Google Colab** 
...
To create a new environment (=myenv):
