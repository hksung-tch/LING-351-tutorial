...
- What: Tokenization is the process of converting a raw text string into a sequence of smaller units called tokens. Tokens typically include words, punctuation marks, numbers, and other meaningful elements in a text. 

- Why: This step is essential in text processing because it allows computers to break down and analyze text in a structured way.

- How: There are many methods for tokenizing text, and the choice of method can vary depending on the goals of your analysis or the linguistic features you want to investigate.
...
- What: Lemmatization means converting each token to its base (dictionary) form.
